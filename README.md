...
Hi! I'm **[Your Name]**, a full-stack developer passionate about democratizing access to financial tools.

**Why I Built This**:
After seeing friends lose money to high-fee advisors and emotional trading decisions, I wanted to build a tool that brings institutional-quality investing to everyone.

**Skills Demonstrated**:
- Full-stack development (Next.js, Python)
- Financial modeling (MPT, Monte Carlo)
